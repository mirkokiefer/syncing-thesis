...
In this section we will focus on three-way merging which is part of the reconciliation phase of our protocol developed in section \ref{sec:main.histo.protocol.detection-propagation}.\\
...
The current state is marked through the source tracking branch as described in \ref{sec:main.histo.protocol.merging}.
