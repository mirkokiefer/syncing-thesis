...
- refer to standard publications on transaction management, p2p replication

- explain why transactions are not suitable

\section{Basic Notions}
TODO:

- reverse definition starting by atoms --> synchronization

- reference popular synchronization protocols

We will start by explaining some basic terminology and try to systematically define what data synchronization is about.
...
\item \emph{Reconciliation} is the final phase where the client updates are merged and conflicts are identified.
